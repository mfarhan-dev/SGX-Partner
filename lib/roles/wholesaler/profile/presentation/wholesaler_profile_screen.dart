...
/// pencil-icon edit on the header, a real Theme picker (wired to
/// themeModeProvider, per instruction that Language should be hidden
/// entirely rather than left cosmetic), a WhatsApp deep link for
/// Contact SGX, and a confirm-before-logout flow that actually signs
/// out of Supabase.
