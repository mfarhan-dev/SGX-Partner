...
class WholesalerPayoutMethodScreen extends ConsumerStatefulWidget {
  const WholesalerPayoutMethodScreen({super.key});

  @override
  ConsumerState<WholesalerPayoutMethodScreen> createState() =>
      _WholesalerPayoutMethodScreenState();
}

class _WholesalerPayoutMethodScreenState
    extends ConsumerState<WholesalerPayoutMethodScreen> {
