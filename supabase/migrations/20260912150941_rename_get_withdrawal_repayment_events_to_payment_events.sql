create or replace function public.get_withdrawal_payment_events(p_withdrawal_id uuid)
...
revoke execute on function public.get_withdrawal_payment_events(uuid) from public;
revoke execute on function public.get_withdrawal_payment_events(uuid) from anon;
grant execute on function public.get_withdrawal_payment_events(uuid) to authenticated;

drop function public.get_withdrawal_repayment_events(uuid);
